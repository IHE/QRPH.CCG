...
<figure>
<img src="image18.png" style="max-width: 100%; object-fit: contain" />
<figcaption><p>Figure 18 – Illustration of the Definitional Content for
CCGs</p></figcaption>
</figure>

The transactions
[QRPH-X2](CCG_v2_x2.html) and
[QRPH-X3](CCG_v2_x3.html)
...
2.  The initial contextual content bundle is submitted to the Guideline
    Engine as one of the inputs to the QRPH-X4 transaction.
...
5.  The set of Resulting Data are ***included*** in the contextual
    ...
    invocation of the QRPH-X4 transaction.
...
7.  As in step-4, the Guideline Performer dispositions the recommended
    ...
    returned by the QRPH-X4 transaction is empty, the processing loop
    ...
    returned by transaction QRPH-X4 at step-4, the processing loop ends
    at this step.
...
- the set of normative **Resulting Data** generated by the Guideline
  Performer after processing prior invocations of the QRPH-X4
  transaction. At the first invocation of QRPH-X4, this content will be
  zero.
